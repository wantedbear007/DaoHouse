              ...
              >
                ...
                >
                  <p className="laptop:text-base text-sm">
                    {readMoreIndex === index ? post.post_description : post.post_description.slice(0, 50)}
                    {post.post_description.length > 120 && (
                      <span
                        className="text-blue-500 cursor-pointer"
                        onClick={() => setReadMoreIndex(readMoreIndex === index ? null : index)}
                      >
                        {readMoreIndex === index ? "..close" : "..more"}
                      </span>
                    )}
                  </p>
