export const constant = () => {
  ...
  const convertNanosecondsToTimeAgo = (
  ...
  const convertInt8ToBase64 = (int8Array: Int8Array | undefined) => {
    try {
      ...
      const base64 =
        ...
        btoa(String.fromCharCode(...new Uint8Array(int8Array)));
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    return new Promise<{ int8Array: Int8Array; base64: string }>(
      (resolve, reject) => {
  ...
  return {
    convertNanosecondsToTimestamp,
    handleFileUpload,
    convertInt8ToBase64,
    convertNanosecondsToTimeAgo,
  };
};
