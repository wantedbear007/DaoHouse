...
export default function Card({ proposal, showActions, isProposalDetails }) {
  ...
  if(isProposalDetails){
    return (
      <div className="bg-white font-mulish rounded-sm shadow-md flex flex-col md:flex-col">
        {/* Top Section */}
        <div className="w-full flex justify-between items-center bg-[#0E3746] px-[20px] md:px-12 py-6 rounded-xl rounded-t-lg rounded-b-none">
        ...
        <div className="w-full px-4 lg:px-12 py-4 md:py-8">
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-4 gap-4">
            ...
            <div className="flex gap-4">
              <span className="md:py-1 px-4 rounded-full bg-[#4993B0] text-white font-semibold">
                {timeRemaining}
              </span>
              <span
                className={`px-4 md:py-1 rounded-full text-white text-sm font-semibold ${
          ...
          <p className="text-gray-900 text-sm mb-4">{proposal?.proposal_description}</p>
          <div className="flex flex-wrap gap-4 flex-col md:flex-row md:justify-between items-start md:items-center space-y-4 md:space-y-0 lg:space-x-8">
            <div className="flex flex-col gap-4 items-start justify-start">
                <div className=" flex md:space-x-2 xl:space-x-8">
                  <div className="flex flex-col items-start">
                    <span className="font-bold text-xs md:text-sm lg:text-lg text-gray-900">• Submitted On </span>
                  ...
                  <div className="flex flex-col items-start">
                    <span className="font-bold text-xs md:text-sm lg:text-lg text-gray-900">• Expires On </span>
                  ...
                  <div className="flex flex-col items-start">
                    <span className="font-bold text-xs md:text-sm lg:text-lg text-gray-900">• Votes Required </span>
                    <span className="text-[10px] small_phone:text-xs md:text-sm lg:text-lg ml-2 md:ml-3">{requiredVotes}</span>
                  </div>
                </div>

                <div className="flex justify-evenly md:justify-start mt-6 md:mt-0 space-x-4">
  ...
  return (
        <div className="bg-white rounded-xl font-mulish shadow-md flex flex-col md:flex-row">
          {/* Left Section */}
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-4 gap-4  font-mulish">
        <div className="max-w-full lg:max-w-full">
          <h4 className="text-xl font-bold text-[#0E3746] overflow-hidden text-ellipsis whitespace-nowrap">
            Transfer | <span className="md:text-[1rem] text-[1rem]">Proposal ID: #{proposal?.proposal_id}</span>
          </h4>
