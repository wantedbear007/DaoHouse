...
const About = () => {
  return (
    <div className="bg-[#05212C] relative flex justify-center items-center py-8">
      ...
      <div className="md:w-60% w-full md:p-8 text-white mobile:mx-16 mx-10">
        <div className="md:px-8 md:ml-0 relative z-50 md:z-0 mb-10">
          <h2 className="text-about-heading font-mulish font-normal text-[16ox] md:text-[16ox] lg:text-[16ox] leading-tight mt-4 mb-1">
            About Platform
          </h2>
          <p className="text-about-subheading font-mulish font-medium text-3xl mobile:text-5xl leading-tight mt-1 mb-3">
            Unlocking Collective Intelligence
          </p>
        </div>

        <p className="text-about-content md:mx-w-[550px] flex flex-col font-mulish font-normal text-sm md:text-base lg:text-lg md:p-8 md:mx-0 md:my-4 md:mr-6">
          <span className="pr-4">
