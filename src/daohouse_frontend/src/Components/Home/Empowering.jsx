...
const Empowering = () => {
  return (
    <div className="bg-[#dadee4] py-[8rem] px-[8rem]">
      <h1 className="text-empowering-heading text-center font-mulish font-semibold text-2xl md:text-4xl lg:text-5xl leading-tight mb-6">Empowering Decentralization</h1>
